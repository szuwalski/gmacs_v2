...
{
png(paste("pirkc/plots/size_comp_",x,".png",sep=""),height=8,width=8,res=1200,units='in')
...
for(x in 1:length(mdf))
{
  png(paste("pirkc/plots/size_ridges_",x,".png",sep=""),height=8,width=8,res=1200,units='in')
