...
// ================================================================================================
 ...
 END_CALCS
  ...
  int n_mat_m;
  !! n_mat_m = nsex;
  init_matrix m_mat_controls(1,n_mat_m,1,7);
  
  vector m_mat_ival(1,n_mat_m);
  vector m_mat_lb(1,n_mat_m);
  vector m_mat_ub(1,n_mat_m);
  ivector m_mat_phz(1,n_mat_m);
  ivector prior_m_mat_type(1,n_mat_m);
  vector prior_m_mat_p1(1,n_mat_m);
  vector prior_m_mat_p2(1,n_mat_m); 
 
  vector log_m_mat_ival(1,n_mat_m);
  vector log_m_mat_lb(1,n_mat_m);
  vector log_m_mat_ub(1,n_mat_m);
 ...
 LOC_CALCS
  ...
  log_m_mat_ival   = log(m_mat_ival);
  log_m_mat_lb     = log(m_mat_lb);
  log_m_mat_ub     = log(m_mat_ub);
  ...
  if (IsJittered!=0)
   {
	...
	// Add in immature/mature natural mortalitiy parameters 
