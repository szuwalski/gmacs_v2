...
copy gmacs.exe C:\snow_gmacs_v2\snow
copy gmacs.exe C:\snow_gmacs_v2\bbrkc
copy gmacs.exe C:\snow_gmacs_v2\nsrkc
copy gmacs.exe C:\snow_gmacs_v2\smbkc
copy gmacs.exe C:\snow_gmacs_v2\pirkc
