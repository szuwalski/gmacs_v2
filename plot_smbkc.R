...
.FLEET    = c("Pot","Trawl bycatch","Fixed gear","NMFS Trawl","ADFG Pot")
...
plot_cpue(M, ShowEstErr = TRUE, "ADFG Pot", ylab = "Survey biomass")
...
{
png(paste("smbkc/plots/size_comp_",x,".png",sep=""),height=8,width=8,res=1200,units='in')
...
for(x in 1:length(mdf))
{
  png(paste("smbkc/plots/size_ridges_",x,".png",sep=""),height=8,width=8,res=1200,units='in')
